<?php
    ...
    include("../../thuvien/database.php");
    include("../../thuvien/trangchu.php");
    $email=$_POST['emailxn'];
    $maxacnhan=md5($_POST['maxacnhan']);
    $kiemtramaxacnhan=kiemtramaxacnhan($email,$maxacnhan);

    if(mysql_num_rows($kiemtramaxacnhan)>0)
    {
    	$row=mysql_fetch_array($kiemtramaxacnhan);
