...
<div class="span9">
	...
	<form class="form-horizontal" method="post" action="#" >
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="inputFname1" name="ho" placeholder="Họ">
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label" for="inputLnam">Tên	 <sup>*</sup></label>
			<div class="controls">
			  <input type="text" name="ten" id="inputLnam" placeholder="Tên">
			</div>
		 </div>
		<div class="control-group">
		<label class="control-label" for="input_email">Email <sup>*</sup></label>
		<div class="controls">
		  <input type="email" value="<?=$emailtao?>" name="email" id="input_email" placeholder="Email">
		</div>
	  </div>	  
	<div class="control-group">
		<label class="control-label" for="inputPassword1">Mật khẩu <sup>*</sup></label>
		<div class="controls">
		  <input type="password" name="matkhau" maxlength="32" minlength="6" id="inputPassword1" placeholder="Mật khẩu">
		</div>
	  </div>
	  <div class="control-group">
		<label class="control-label" for="inputPassword2">Mật khẩu <sup>*</sup></label>
		<div class="controls">	
		  <input type="password" name="matkhaunhaplai" maxlength="32" minlength="6" id="inputPassword2" placeholder="Nhập lại Mật khẩu">
		</div>
	  </div>	  
		<div class="control-group">
		...
		<div class="controls">
		  ...
		  <input type="date" name="ngaysinh" min="1940-01-01" max="2017-07-07" />
		</div>
	  </div>
		<div class="control-group">
			<label class="control-label" for="mobile">Số điện thoại </label>
			<div class="controls">
			  <input type="number" maxlength="13" minlength="10"  name="sdt" id="mobile" placeholder="09xxxxxxxx"/> 
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputLnam">Địa chỉ	 <sup>*</sup></label>
			<div class="controls">
			  <input type="text" name="diachi" id="inputLnam" placeholder="Địa chỉ">
			</div>
		 </div>
