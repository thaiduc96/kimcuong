...
$nam="";
$nu="";
if($user['gioitinh']==1) {$nam="selected=''"; }
else { $nu="selected=''"; }
...
<div class="row">
	...
	<div class="span6">
			<form class="form-horizontal" method="post" action="#" >
				...
				<div class="controls">
				  <input type="email" disabled="" value="<?=$user['email']?>" name="email" id="input_email" placeholder="Email">
				</div>
			  </div>	    
				<div class="control-group">
				<label class="control-label">Ngày sinh <sup>*</sup></label>
				<div class="controls">
				  <input type="date" value="<?=$user['ngaysinh']?>" name="ngaysinh" min="1940-01-01" max="2017-07-07" />
				</div>
			  </div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
					  <input type="text" name="diachi" value="<?=$user['diachi']?>" id="inputLnam" placeholder="Địa chỉ">
					</div>
				 </div>
