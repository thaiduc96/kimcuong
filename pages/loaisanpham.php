...
<div class="span9">
	...
	<h3> <?=$loaisp['tenloaiSP']?> <small class="pull-right"> <?=$soluong?> sản phẩm có sẵn </small></h3>	
...
?>
	<div class="pagination" align="center">
			<ul>
			<li><a href="index.php?p=loaisanpham&idloaiSP=<?=$idloaiSP?>&trang=<?php echo $trang-1?>">&lsaquo;</a></li>
			<?php
			...
			?>
			<li><a href="index.php?p=loaisanpham&idloaiSP=<?=$idloaiSP?>&trang=<?php echo $trang+1?>">&rsaquo;</a></li>
			</ul>
			</div>
			<br class="clr"/>
</div>