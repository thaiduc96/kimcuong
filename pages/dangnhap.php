		...
		<div class="span4">
			...
			<form method="post" action="#">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input type="password" name="matkhaudn" class="span3"  id="inputPassword1" placeholder="Password">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" name="dangnhap" class="btn">Đăng nhập</button> <a href="index.php?p=quenmatkhau">Quên mật khẩu?</a>
				</div>
			  </div>
			</form>
		</div>
