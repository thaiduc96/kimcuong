    	...
    	<form class="form-horizontal" method="post" action="">
            <fieldset>
              <div class="control-group">
                ...
                <div class="controls">  
                  <input type="text" name="tennguoinhan" value="<?=$_SESSION['ten']?>" class="input-xlarge" id="input01">
    		   ...
    		   <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="noinhan" value="<?=$_SESSION['diachi']?>" class="input-xlarge" id="input11">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="sdtdh" value="<?=$_SESSION['sdt']?>" class="input-xlarge" id="input11">
    		   ...
    		   <div class="control-group">  
                ...
                <div class="controls">
                  <textarea class="input-xlarge" name="ghichudh" id="textarea" rows="3" style="height:65px"></textarea>
                </div>
              </div>
