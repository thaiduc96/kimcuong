...
<div class="span9">
    ...
    <div class="pagination" align="center">
        <ul>
            <li>
                <a href="index.php?p=timkiem&idTL=<?= $idTL ?>&key=<?= $key ?>&trang=<?php echo $trang - 1 ?>">&lsaquo;</a>
            </li>
            <?php
            ...
            ?>
            <li>
                <a href="index.php?p=timkiem&idTL=<?= $idTL ?>&key=<?= $key ?>&trang=<?php echo $trang + 1 ?>">&rsaquo;</a>
            </li>
        </ul>
    </div>
    <br class="clr"/>
