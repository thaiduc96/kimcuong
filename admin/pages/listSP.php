                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php 
                        	...
                        	{
                        		$hinhchitiet=hinhchitiet($row['idSP']);
                        ?>
	                        <tr class="odd gradeX">
	                            <td><?=$row['idSP']?></td>
	                            <td><?=$row['tenSP']?></td>
	                            ...
	                            <td><?=$row['solanxem']?></td>
	                            <td><?=$row['anhien']?></td>
	                            <td><?=theloaitheoid($row['idTL'])?></td>
	                            <td><?=loaisanphamtheoid($row['idloaiSP'])?></td>
	                            <td><?=$row['khuyenmai']?></td>
	                            <td><?=$row['soluong']?></td>
	                            <td><?=$row['daban']?></td>
	                           	 <td><a onclick="return confirm('Bạn có chắc muốn xoá không')" href="pages/xoasp.php?idSP=<?=$row['idSP']?>">Xoá</a>  <a href="index.php?p=suasp&idSP=<?=$row['idSP']?>">Sửa</a> </td>
	                        </tr>
	                     <?php
	                     	}
	                    ?>
