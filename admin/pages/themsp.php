...
if(isset($_POST['themSP']))
{
    ...
    if(isset($_FILES['fImages']))
    {
    	...
    	{
    		if(themsp($idTL,$idloaiSP,$tenSP,$gia,$noidung,$khuyenmai,$soluong,$tomtat,$tenhinh,$anhien,$ngay)==TRUE)
  			{
		    	...
		    	move_uploaded_file($file_tmp,"../images/".$tenhinh);
			  	if(themchitiet($trongluong,$chungloai,$tuoi,$mauchatlieu,$gioitinh,$mota)==FALSE)
			  	{
			  		$flag=2;
    ...
    <div class="col-md-7 col-sm-12 col-xs-12">
        <!-- Advanced Tables -->
	           ...
	           <div class="form-group">
	        	...
	        	<div class="form-group">
	                <label>Giá</label>
	                <input class="form-control"   type="number" min="100000" max="999999999999" name="gia" placeholder="Giá" />
	            </div>

	            <div class="form-group">
	                <label>Khuyến mãi</label>
	                <input class="form-control"  type="number" min="0" max="100" name="khuyenmai" placeholder="Phần trăm khuyến mãi" />
	            </div>

	            <div class="form-group">
	                <label>Số lượng sản phẩm</label>
	                <input class="form-control"  type="number" min="0" max="100" name="soluong" placeholder="Số lượng sản phẩm ban đầu" />
	            </div>

	            <div class="form-group">
	                <label>Tóm tắt</label>
	                <textarea class="form-control" rows="3" name="txtTomtat" placeholder="Tóm tắt ngắn gọn về sản phẩm"></textarea>
	            </div>
    ...
    <div class="col-md-5 col-sm-12 col-xs-12">
    	<div class="panel-body panel">
    		 ...
    		 <div class="form-group">
	            ...
	            <div class="form-group">
	                <label>Mô tả</label>
	                <textarea class="form-control" rows="3" name="mota" placeholder="Mô tả sản phẩm hiển thị ở thông tin chi tiết sản phẩm..." ></textarea>
	            </div>
