<?php
$donDHchuanhan = $trangadmin->dathang(0);
$sodon = count($donDHchuanhan);

$danhsachlienhe = $trangadmin->danhsachlienhe(0);
$solienhe = count($danhsachlienhe);
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box">
                    <p class="main-text"><a href="index.php?p=lienhe&xacnhan=0"><?= $solienhe ?> thư </a></p>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box">
                    ...
                    ?>
                    <p class="main-text"><a href="index.php?p=dathang&xacnhan=0"><?= $sodon ?> đơn hàng</a></p>
