...
<?php
    ...
    if(suatl($idTL,$tenTL,$thutu,$anhien,$tomtat)==TRUE)
    {
      ...
      <div class="panel-body">
          <form action="" method="POST">
            <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?=$row['tenTL']?>" name="tenTL" placeholder="Tên sản phẩm" />
              </div>
              <div class="form-group">
                  <label>Thứ tự</label>
                  <input type="text" class="form-control" value="<?=$row['thutu']?>" name="thutu" placeholder="Thứ tự" />
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="tomtat" placeholder="Tóm tắt ngắn gọn về về loại"><?=$row['tomtat']?></textarea>
              </div>
