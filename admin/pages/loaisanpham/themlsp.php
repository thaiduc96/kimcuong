...
<?php
	if(isset($_POST["btnThem"]))
	{
		...
		$idTL = $_POST["idTL"]; 
		$tomtat = $_POST["Tomtat"];
	   if(themloaisp($tenloaiSP,$tenloai_khongdau,$thutu,$anhien,$idTL,$tomtat)==TRUE)
      {
          ...
          <form action="" method="POST">
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="Tomtat" placeholder="Tóm tắt ngắn gọn về loại sản phẩm"></textarea>
              </div>
