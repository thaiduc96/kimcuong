                ...
                <!-- DO DL vao day  -->
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                                ...
                                <td>{anhien}</td>
                                <td>{tenTL}</td>
                                <td><a href="index.php?p=sualsp&idloaiSP={idloaiSP}">Sửa</a>-<a href="pages/loaisanpham/xoalsp.php?idloaiSP={idloaiSP}">Xóa</a></td>
                                </tr>  
                                <?php 
									$s = ob_get_clean();
									...
									$s=str_replace("{tenTL}",theloaitheoid($row_loaiSP["idTL"]),$s);
