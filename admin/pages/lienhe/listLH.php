                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>{chude}</td>
                                <td>
                                    <select class="form-control xacnhanthulienhe" id="thulienhe" name="thulienhe" idLienHe="<?=$row_lh['idLH']?>">
                                        <option value="1" <?php if($row_lh['xacnhan']==1) echo "selected=''"; ?>  >Đã nhận</option>
                                        <option value="0" <?php if($row_lh['xacnhan']==0) echo "selected=''"; ?> >Chưa nhận</option>
                                    </select>
                                </td>
                                 <td><a onclick="return confirm('Bạn có chắc muốn xoá không')" href="pages/xoatl.php?idTL={idTL}">Xoá</a></td>
                                </tr>
