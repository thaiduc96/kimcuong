    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">            
                 ...
                 {	
                 	switch ($p) {
                 		case 'listSP': require "pages/listSP.php";
                 			break;
                 		case 'themsp': require "pages/themsp.php";
                            break;
                        case 'suasp': require "pages/suasp.php";
                            break;
                        case 'listtl': require "pages/listtl.php";
                            break;
                        case 'suatl': require "pages/suatl.php";
                            break;
                        case 'themtl': require "pages/themtl.php";
                            break;
                        case 'listlsp': require "pages/loaisanpham/listlsp.php";
                            break;
                        case 'themlsp': require "pages/loaisanpham/themlsp.php";
                            break;
                        case 'sualsp': require "pages/loaisanpham/sualsp.php";
                            break;
                        case 'dathang': require "pages/dathang.php";
                            break;
                        case 'donhang': require "pages/chitietdonhang.php";
                            break;
                        case 'listUser': require "pages/user/listUser.php";
                            break;
                        case 'lienhe': require "pages/lienhe/listLH.php";
                            break;    
                 		default:
                 			break;
                 	}
