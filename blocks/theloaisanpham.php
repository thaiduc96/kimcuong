...
$ketquatren=$trangchu->sanphamtheotheloai_phantrang($idTL,$from,$sotintrang);
...
<div class="span9">	
    <ul class="breadcrumb">
		...
		<li class="active"><?=$loaisp['tenloaiSP']?></li> //bo dong nay
    </ul>
...
<div class="tab-content">
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
		<?php
			while($rowduoi=mysql_fetch_array($ketquaduoi))
			{
		?>
			<li class="span3">
			  <div class="thumbnail">
