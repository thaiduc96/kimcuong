...
<div id="mainBody">
	...
	<!-- Sidebar end=============================================== -->
		<?php
			switch ($p) {
				case 'loaisanpham':require"pages/loaisanpham.php";
					break;
				case "timkiem":require "pages/timkiem.php";
					break;
				case "khuyenmai":require "pages/khuyenmai.php";
					break;
				case "dangki":require "pages/dangki.php";
					break;
				case "dangnhap":require "pages/dangnhap.php";
					break;
				case "giohang":require "pages/giohang/giohang.php";
					break;
				case "muahang":require "pages/giohang/muahang.php";
					break;
				case "sosanh":require "pages/sosanh.php";
					break;
				case "dieukhoan":require "pages/dieukhoan.php";
					break;
				case "faq":require "pages/faq.php";
					break;
				case "lienhe":require "pages/lienhe.php";
					break;	
				
				case "theloaisanpham":require "pages/theloaisanpham.php";
					break;	
				case "chitiet":require "pages/chitiet.php";
					break;
				
				case "canhan":require "pages/canhan.php";
					break;	


				case "doimatkhau":require "pages/timmatkhau/doimatkhau.php";
					break;	
				case "xacnhanemail":require "pages/timmatkhau/xacnhanemail.php";
					break;		
				case "quenmatkhau":require "pages/timmatkhau/quenmatkhau.php";
					break;					
				default:
